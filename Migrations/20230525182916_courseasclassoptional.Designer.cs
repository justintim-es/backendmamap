...
namespace latest.Migrations
{
    ...
    [Migration("20230525182916_courseasclassoptional")]
    partial class courseasclassoptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("latest.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("latest.Models.Course", b =>
                {
                    b.HasOne("latest.Models.CareGiver", "CareGiver")
                        .WithOne("Course")
                        .HasForeignKey("latest.Models.Course", "CareGiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
